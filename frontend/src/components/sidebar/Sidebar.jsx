  ...
  const items = [
    {
      ...
      children: [{ name: "Chọn cửa hàng (Manager)", path: "/select-store" }],
    },
    {
      name: "Người dùng",
      path: "/users",
    ...
    },
    {
      ...
      icon: <FiStar size={20} />,
      children: [
        { name: "Cấu hình hệ thống", path: "/loyalty/config" },
      ],
    },
    {
      name: "Báo cáo",
      ...
      >
        <div className="p-6 flex flex-col h-full">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-3xl font-extrabold text-green-700 tracking-wide drop-shadow-lg">Smallbiz-Sales</h2>
