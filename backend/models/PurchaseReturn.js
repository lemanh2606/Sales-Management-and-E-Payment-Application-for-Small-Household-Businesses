...
const purchaseReturnSchema = new mongoose.Schema({
  ...
  purchase_order_id: { type: mongoose.Schema.Types.ObjectId, ref: 'PurchaseOrder', required: false }, // Link to the original purchase order
  ...
  created_by: { type: mongoose.Schema.Types.ObjectId, ref: 'User', required: true }, // Người tạo
