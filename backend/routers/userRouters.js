...
const { registerManager, verifyOtp,login, logout, refreshToken, updateProfile, updateUser, sendPasswordOTP,
        changePassword, softDeleteUser, restoreUser, sendForgotPasswordOTP, forgotChangePassword} = require("../controllers/user/userController");

const { verifyToken, isManager, isStaff, checkStoreAccess, requirePermission} = require("../middlewares/authMiddleware");
