...
router.post(
  "/activate",
  verifyToken,
  requirePermission("subscription:activate"),
  activatePremium
);
...
router.get(
  "/history",
  verifyToken,
  requirePermission("subscription:history"),
  getPaymentHistory
);
...
// POST /api/subscriptions/clear-pending – Xoá các pending payment đã quá hạn (subscription:manage)
router.post(
  "/clear-pending",
  verifyToken,
  requirePermission("subscription:manage"),
