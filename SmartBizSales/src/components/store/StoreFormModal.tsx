        ...
        >
          <View style={styles.modalContent}>
            ...
            >
              ...
              <View style={styles.field}>
                ...
                <View style={styles.inputWrapper}>
                  ...
                  <TextInput
                    ...
                    placeholderTextColor="#9ca3af"
                    onBlur={() =>
                      localForm.address && handleAutoGeocode(localForm.address)
                    }
                  />
                </View>
              ...
              <View style={styles.field}>
                <Text style={styles.label}>
                  Tags (Ví dụ: cà phê, trà đá, bún chả)
                </Text>
                <View style={styles.inputWrapper}>
                  <Ionicons
                ...
                <View style={styles.toggleRow}>
                  <View>
                    ...
                    <Text style={styles.toggleDesc}>
                      Tự động chọn khi vào ứng dụng
                    </Text>
                  </View>
                  <TouchableOpacity
                    onPress={() =>
                      updateField("isDefault", !localForm.isDefault)
                    }
                    style={[
                      styles.toggleSwitch,
                      localForm.isDefault && styles.toggleSwitchActive,
                    ]}
                  >
                    <View
                      style={[
                        styles.toggleCircle,
                        localForm.isDefault && styles.toggleCircleActive,
                      ]}
                    />
                  </TouchableOpacity>
                </View>
            ...
            <View style={styles.footer}>
              ...
              >
                {busy ? (
                  ...
                  <Text style={styles.saveActionText}>Lưu cửa hàng</Text>
                )}
              </TouchableOpacity>
            </View>
          </View>
